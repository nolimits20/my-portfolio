...
const About = () => {
  ...
  return (
    <div id='about' ref={ref} className='bg-[#081C15] min-h-screen w-full relative flex flex-col md:flex-row md:px-12 overflow-x-hidden pt-16'>
      ...
      >
        <h1 className='text-white font-bold text-2xl md:text-4xl lg:text-6xl mb-4 md:mb-8'>ABOUT <span className='text-[#52B788]'>ME</span></h1>
        ...
        <h2 className='text-[#52B788] font-bold text-sm md:text-2xl mb-3 md:mb-4'>What I Do</h2>
        ...
        <h2 className='text-[#52B788] font-bold text-sm md:text-2xl mb-3 md:mb-4'>My Toolbox</h2>
